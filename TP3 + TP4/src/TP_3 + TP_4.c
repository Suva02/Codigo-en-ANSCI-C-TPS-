    ...
    do{
    		...
    		switch(option)
    		{
    			case 1:
    				...
    				{
    					controller_loadFromText("src\\data.csv", listaEmpleados);
    					TextModeControl = 1;
					}
					else
					{
    			...
    			case 2:
    				 if(TextModeControl == 0 && BinaryModeControl == 0)
    				 {
						controller_loadFromBinary("src\\data.bin", listaEmpleados);
						BinaryModeControl = 1;
    				 }
    				 else
    				 {
				...
				case 9:
					if(TextModeControl == 1 || BinaryModeControl == 1)
					{
						  controller_saveAsBinary("src\\data.bin",listaEmpleados);
					}
					else
					{
						printf("\nError al guardar datos! No hay empleados en el sistema...\n\n");
    			...
    			case 10:
    				...
    				{
    					printf("\n\nError al limpiar lista! No hay empleados en el sistema...\n\n");
    				}
    			...
    			case 11:
    				...
    				if(TextModeControl == 1 || BinaryModeControl == 1)
    				{
    					  printf("\n(Se libero la memoria del sistema...)\n\n");
    				      controller_freeLinkedList(listaEmpleados);
    				}
    				else
    				{
    					printf("\n\n(La memoria no se libero ya que no hay empleados en el sistema...)\n\n");
    				}
    			break;
    		}
